...
{
	private static readonly HashSet<ushort> _definedValues = new()
	{
		(ushort)Tests.TestEnum.Member0,
		(ushort)Tests.TestEnum.Member1,
		(ushort)Tests.TestEnum.Member2,
		(ushort)Tests.TestEnum.Member3,
		(ushort)Tests.TestEnum.Member4,
		(ushort)Tests.TestEnum.Member5,
		(ushort)Tests.TestEnum.Member6,
	};
	...
	{
		return _definedValues.Contains((ushort)value);
	}
}
