...
{
	private static readonly HashSet<short> _definedValues = new()
	{
		(short)Tests.TestEnum.Member0,
		(short)Tests.TestEnum.Member1,
		(short)Tests.TestEnum.Member2,
		(short)Tests.TestEnum.Member3,
		(short)Tests.TestEnum.Member4,
		(short)Tests.TestEnum.Member5,
		(short)Tests.TestEnum.Member6,
	};
	...
	{
		return _definedValues.Contains((short)value);
	}
}
