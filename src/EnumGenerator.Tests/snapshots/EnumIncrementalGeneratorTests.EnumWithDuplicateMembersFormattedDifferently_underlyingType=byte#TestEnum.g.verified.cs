...
public static class TestEnumGen
{
	...
	{
		(byte)Tests.TestEnum.Member0,
		(byte)Tests.TestEnum.Member1,
		(byte)Tests.TestEnum.Member2,
		(byte)Tests.TestEnum.Member3,
		(byte)Tests.TestEnum.Member4,
		(byte)Tests.TestEnum.Member5,
		(byte)Tests.TestEnum.Member6,
	};
